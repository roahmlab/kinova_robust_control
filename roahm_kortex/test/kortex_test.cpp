...
using namespace Roahm::Kortex;

class ZeroControlBlock : public Roahm::System::BaseBlock
{
  private:
  ...
  private:
    ZeroControlBlock()
        : Roahm::System::BaseBlock(
              "zero_block",
              Roahm::System::OutputPort<ControlMsg>::make_shared()),
          measurement(register_input<Measurement>("measurement"))
    {
    }

    Roahm::System::AbstractInputPort::SharedPtr measurement;
};
...
TEST(KortexTest, KortexBlockTest)
{
    ...
    Roahm::System::System system("KortexBlockTestSystem");
