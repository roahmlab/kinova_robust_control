...
#include "customized_msgs/msg/torque_control.hpp"
#include "customized_msgs/srv/bool.hpp"
#include "customized_msgs/srv/goto.hpp"
#include "customized_msgs/srv/goto_name.hpp"
#include "customized_msgs/srv/goto_cartesian.hpp"
#include "customized_msgs/srv/gripper_action.hpp"
...
using namespace customized_msgs::srv;
...
class RosSystemWrapper
{
  public:
    ...
    void run()
    {
        auto goto_srv = node->create_service<customized_msgs::srv::Goto>(
            NODE_NAME + "/goto",
            std::bind(&RosSystemWrapper::goto_pos, this, _1, _2));

        auto goto_name_srv = node->create_service<customized_msgs::srv::GotoName>(
            NODE_NAME + "/goto_name",
            std::bind(&RosSystemWrapper::goto_predefined, this, _1, _2));
        
        auto goto_cartesian_srv = node->create_service<customized_msgs::srv::GotoCartesian>(
            NODE_NAME + "/goto_cartesian",
            std::bind(&RosSystemWrapper::goto_cartesian, this, _1, _2));

        auto close_gripper_srv = node->create_service<customized_msgs::srv::GripperAction>(
            NODE_NAME + "/close_gripper",
            std::bind(&RosSystemWrapper::close_gripper, this, _1, _2));

        auto reset_gripper_srv = node->create_service<customized_msgs::srv::GripperAction>(
