...
class ControllerBlock : public ::KinovaRobustControl::System::BaseBlock
{
  protected:
    using ControlMsg = ::KinovaRobustControl::msgs::ControlMsg;
    using Measurement = ::KinovaRobustControl::msgs::Measurement;
    struct InputPack;
