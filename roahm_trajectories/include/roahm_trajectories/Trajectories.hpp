...
#include "roahm_trajectories/ArmtdCurve.hpp"
#include "roahm_trajectories/ArmourBezierCurve.hpp"
#include "roahm_trajectories/FixedFrequencyFourierCurve.hpp"
#include "roahm_trajectories/FifthOrderBezierCurve.hpp"
 ...
 * @note the implementation is required and can be found in roahm_trajectories/
 **/
class Trajectory
{
public:
     ...
     *       the implementation is required and can be found in roahm_trajectories/
     **/
    ...
    // trajectory type (defined in roahm_msgs/TrajectoryTypeMacros.hpp)
